namespace _05FilterByAge
{
    ...
    public class FilterByAge
    {
        public static void Main()
        {
            ...
            InvokerPrinter(people, tester, printer);
        }

        private static void InvokerPrinter(Dictionary<string, int> people, Func<int, bool> tester, Action<KeyValuePair<string, int>> printer)
        {
